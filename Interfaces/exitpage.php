...
?>
    ...
    <head>
        <meta charset="utf-8">
        <title>Bubbles Groovy Smoothies Exit Page</title>
        ...
        <div class="border">
            ...
            <div class="row">
                <div class="column image">
                    <style>
                        .column.image {
                            background-image: url("Css_Styling/Images/exit.jpeg");
                            background-color: pink;
                            background-position: top;
                            background-repeat: no-repeat;
                            background-size: cover;
                ...
                <div class="column content">
                    ...
                    <div class="welcome">
                        <h2>Thank you!</h2>
                        <h3>Bubbles Groovy Smoothies welcomes you again!</h3>
                        <h4>Your order will be ready shortly!</h4>
                    </div>

                    <div class="details">

                        <!-- <img src="Images/smiley.jpeg" width="460" height="300"> -->
